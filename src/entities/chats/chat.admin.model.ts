...
type ChatState = {
    chats: Record<number, ChatMessageDto[]> // Сообщения сгруппированы по chatId
    isLoading: Record<number, boolean> // Состояние загрузки по chatId
    error: Record<number, string | null> // Ошибки по chatId
...
export const useChatAdminStore = create<ChatState>()(
    immer((set, get) => ({
        chats: {},
        isLoading: {},
        error: {},
