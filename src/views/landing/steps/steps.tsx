...
export function Steps() {
    return (
        <div className='hidden lg:flex flex-col pt-[120px] justify-center items-center'>
            ...
            <div className='bg-[#FF8787] uppercase rounded-lg text-white px-8 xl:px-[60px] xl:py-[24px] py-3 mt-[50px] xl:mt-[64px] font-light text-sm sm:flex sm:justify-center items-center lg:font-bold lg:text-base xl:text-[20px]'>
                Начать сейчас
            </div>
        </div>
    )
