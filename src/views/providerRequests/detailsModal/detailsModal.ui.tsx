...
import { Categories, UploadDto } from '@/shared/lib/horekaApi/Api'
...
export function DetailsModal({ id }: { id: number }) {
    ...
    const { data, isLoading } =
        providerRequest.useProviderRequestGetIncomeByID(id)
    console.log(data)
...
export function handleDetailsModal(id: number) {
    return modals.open({
        modalId: 'DetailsModal',
        children: <DetailsModal id={id} />,
        centered: true,
        size: 'xl',
        radius: 'lg',
    })
